...
import oresAboveDiamonds.OresMod.config.Config;
...
public class OresAboveDiamonds 
{
	...
	//public static final ItemGroup ores = new OresItemGroup();
	...
	public OresAboveDiamonds() 
	{
		...
		Config.loadConfig(Config.config, FMLPaths.CONFIGDIR.get().resolve("oresabovediamonds.toml").toString());
